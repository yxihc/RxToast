...
public final class RxSnackbar {
    ...
    private RxSnackbar(final View parent) {
        setDefault();
        this.parent = parent;
    }
     ...
     * @return {@link RxSnackbar}
     */
    public static RxSnackbar with(@NonNull final View parent) {
        return new RxSnackbar(parent);
    }
     ...
     * @return {@link RxSnackbar}
     */
    public RxSnackbar setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return {@link RxSnackbar}
     */
    public RxSnackbar setMessageColor(@ColorInt final int color) {
     ...
     * @return {@link RxSnackbar}
     */
    public RxSnackbar setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return {@link RxSnackbar}
     */
    public RxSnackbar setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return {@link RxSnackbar}
     */
    public RxSnackbar setDuration(@Duration final int duration) {
     ...
     * @return {@link RxSnackbar}
     */
    public RxSnackbar setAction(@NonNull final CharSequence text,
     ...
     */
    public RxSnackbar setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
